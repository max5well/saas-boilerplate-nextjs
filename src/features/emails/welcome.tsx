        ...
        <Body className='mx-auto my-auto bg-slate-500 px-2 py-10 font-sans'>
          <Container className='mx-auto mt-[40px] w-[464px] overflow-hidden rounded-md bg-white'>
            ...
            <Section className='p-8'>
              <Heading as='h2' className='m-0 text-[24px] font-bold'>
                Thanks for signing up for {siteConfig.name}.
              </Heading>
              <Text className='my-6 text-[16px]'>Go to your account to get started.</Text>
          ...
          <Container className='mx-auto mt-4'>
            <Section className='text-center'>
              ...
              <Link className='text-center text-xs text-white underline' href={baseUrl + '/account/settings'}>
