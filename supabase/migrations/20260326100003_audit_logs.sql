/**
 * AUDIT LOGS
 * Immutable log of user actions for compliance, debugging, and security.
 */
...
-- Service role inserts audit logs (no user-facing insert policy)
...
-- Helper function to create an audit log entry (called from server-side code)
